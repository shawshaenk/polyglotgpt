...
const ChatLabel = ({ openMenu, setOpenMenu, id, name }) => {
  ...
  return (
    <div
      onClick={selectChat}
      className={`flex items-center justify-between p-2 text-white/80 hover:bg-white/10 rounded-lg text-sm cursor-pointer mb-2 ${
    ...
    >
      ...
      {user && (
        <div
          ...
          className={`group relative flex items-center justify-center h-6 w-6 aspect-square hover:bg-black/30 rounded-lg ${
        ...
        >
          ...
          <div
            ...
            } -right-0 top-6 bg-[#252525] rounded-xl w-max p-2 z-10`}
          >
            <div
