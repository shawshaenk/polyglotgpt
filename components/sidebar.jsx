  ...
  return (
    <div
      ...
      <div>
        ...
        <button onClick={createNewChat} className={`${expand ? "absolute top-5.5 left-6 bg-primary hover:opacity-90 rounded-2xl gap-2 p-2.5" : "mt-8 flex justify-center group h-9 w-9 mx-auto hover:bg-gray-500/30 rounded-lg"} flex items-center cursor-pointer`}>
