      ...
      <div>
        ...
        >
          ...
          <div
            ...
            className="group relative flex items-center justify-center hover:bg-gray-500 h-9 w-9 aspect-square rounded-lg cursor-pointer"
          >
            <Image
        ...
        >
          <Image
            ...
            alt=""
          />
          <div className="absolute select-none left-full ml-3 top-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 bg-black text-white text-sm px-3 py-2 rounded-lg shadow-lg pointer-events-none w-23">
            New Chat
            <div className="w-3 h-3 absolute bg-black rotate-45 left-1.5 -translate-x-full top-1/2 -translate-y-1/2"></div>
          </div>
          {expand && (
            <p className="text-white text font-medium select-none">New Chat</p>
          )}
        </button>
      </div>
        ...
        >
          ...
          {user && expand && (
            <Image
              ...
              className="w-5 select-none hover:opacity-60 mb-0.5 ml-17 transition-all duration-100 cursor-pointer"
            />
          )}
        </div>
      </div>
